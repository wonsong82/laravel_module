...
<div class="form-group col-md-12 checklist_dependency"  data-entity ="{{ $field['field_unique_name'] }}" @include('crud::inc.field_wrapper_attributes')>
    ...
    <?php
        ...
        if(isset($primary_dependency['scope'])){
            $scope = $primary_dependency['scope'];
            unset($primary_dependency['scope']);
            $dependencies->where($scope);
        }
    ...
    @foreach ($dependencies as $connected_entity_entry) {{-- EDIT BY WON --}}
