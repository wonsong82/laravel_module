...
@endif
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="{{ asset('vendor/adminlte/') }}/bower_components/jquery-ui/themes/smoothness/jquery-ui.min.css">
    ...
    <link rel="stylesheet" href="{{ asset('vendor/lipis/flag-icon-css/css/flag-icon.min.css') }}">

    {{--<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">--}}

    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,300i,400i,600i">
...
{{--<link rel="stylesheet" href="{{ asset('vendor/backpack/backpack.custom.css') }}">--}}
...
<!-- =============================================== -->
    ...
    @if(!($crud->trim ?? false))
        @include('backpack::base.inc.aside')
    @endif
